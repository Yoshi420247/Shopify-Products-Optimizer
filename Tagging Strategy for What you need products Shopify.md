what\_you\_need\_tagging\_spec:  
  ...
  version: "1.0"  
  last\_updated: "2025-12-08"

  context: |  
    Scope

    \- This spec covers only products where the Shopify "Vendor" column equals "What You Need".  
    \- These are all smokeshop items: glass and silicone devices, quartz, torches, rolling papers, grinders, tools, electronic pieces, packaging, and accessories.  
  ...
  input\_schema: |  
    ...
    The export file "products\_export\_1.csv" contains one row per product for the What You Need vendor.
    ...
    \- Tags  
      \- Contains legacy tags such as "c:Bongs & Water Pipes", "f:material:glass", "b:RAW", "sc:Zig Zag".  
  ...
  tag\_dimensions: |  
    ...
    \- Purpose: functional product family used for navigation and on site collections.  
  ...
  product\_family\_rules: |  
    ...
    \- use: use:dabbing.  
    \- Pendants:  
      \- If a carb cap is described as a pendant carb cap, keep family:carb-cap and add style:pendant only if you want to treat that like a style, not as a separate family.
    ...
    \- material:  
      \- Use material:metal, material:aluminum, material:wood, or material:plastic as copy indicates.  
    ...
    \- material:  
      \- If the copy calls out special materials such as hemp, rice, or rose petals, you can simply leave material unspecified or use material:paper. Material is less important for papers in this spec.  
    \- format: format:paper.  
    \- use: use:rolling.  
    \- brand:  
    ...
    \- material:  
      \- Use material:quartz.  
    \- format: format:banger for bangers, format:cap for carb caps.  
    \- use: use:dabbing.  
    \- Joint details:  
  ...
  llm\_workflow: |  
    ...
    \- Remove any legacy tags from the suggested output.  
